    ...
    public void engineUpgradeButton(){
        ...
        for (int i = 0; i < length.Length ; i++) {
            generateArray("engineUpgrade", engineUpgrade, length, i, enginePrice,
                ...
                PlayerPrefs.GetInt((list.vehicles[PlayerPrefs.GetInt("pointer")].GetComponent<ControlPosta>().carName + "engineUpgrade").ToString())
                ) ;
        }
    ...
    public void spoilerUpgradeButton(){
        ...
        for (int i = 0; i < length.Length ; i++) {
            generateArray("spoilerUpgrade", spoilerUpgrade, length,i, spoilerPrice,
                PlayerPrefs.GetInt((list.vehicles[PlayerPrefs.GetInt("pointer")].GetComponent<ControlPosta>().carName + "spoilerUpgrade").ToString())
                );
        }
    ...
    public void nitrusUpgradeButton(){
        ...
        for (int i = 0; i < length.Length ; i++) {
            generateArray("nitrusUpgrade", nitrusUpgrade, length,i, nitrusPrice,
                PlayerPrefs.GetInt((list.vehicles[PlayerPrefs.GetInt("pointer")].GetComponent<ControlPosta>().carName + "nitrusUpgrade").ToString())
                );
        }
    ...
    public void colorUpgradeButton(){
        ...
        for (int i = 0; i < length.Length ; i++) {
            generateArray("colorUpgrade", colorUpgrade, length,i, colorPrice,
                PlayerPrefs.GetInt((list.vehicles[PlayerPrefs.GetInt("pointer")].GetComponent<ControlPosta>().carName + "colorUpgrade").ToString())
                );
        }
    ...
    public void wheelUpgradeButton(){
        ...
        for (int i = 0; i < length.Length ; i++) {
            generateArray("wheelUpgrade", wheelUpgrade, length,i, wheelPrice,
                PlayerPrefs.GetInt((list.vehicles[PlayerPrefs.GetInt("pointer")].GetComponent<ControlPosta>().carName + "wheelUpgrade").ToString())
                );
        }
    ...
    public void handlingUpgradeButton(){
        ...
        for (int i = 0; i < length.Length ; i++) {
            generateArray("handlingUpgrade", handlingUpgrade, length,i, handlingPrice,
                PlayerPrefs.GetInt((list.vehicles[PlayerPrefs.GetInt("pointer")].GetComponent<ControlPosta>().carName + "handlingUpgrade").ToString())
                );
        }
