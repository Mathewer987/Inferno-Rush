...
public class AudioPablo : MonoBehaviour
{
  ...
  ;
    ...
    private void Update()
    {
        ...
        if (m_StartedSound)
        {
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, RR.engineRPM / RR.maxRPM);
            ...
            else
            {
                ...
                float highFade = Mathf.InverseLerp(0.2f, 0.8f, RR.engineRPM / RR.maxRPM);
